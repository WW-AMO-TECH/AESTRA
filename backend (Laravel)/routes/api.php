...
//  ---------------- ADMIN + SUPER ADMIN ROUTES ---------------------------------------------------------------------------
    Route::middleware(['auth:sanctum','role:admin,super_admin'])->group(function () {
        ...
        // Route::post('/pickup-locations', [PickupLocationController::class, 'store']); // CREATE PICKUP LOCATION
        // Route::get('/pickup-locations', [PickupLocationController::class, 'index']); // VIEW PICKUP LOCATIONS
        // Route::put('/pickup-locations/{id}', [PickupLocationController::class, 'update']); // UPDATE PICKUP LOCATION
        // Route::delete('/pickup-locations/{id}', [PickupLocationController::class, 'destroy']); // DELETE PICKUP LOCATION
    });
//  ---------------------- ---------------------------------------------------------------- -------------------------------
